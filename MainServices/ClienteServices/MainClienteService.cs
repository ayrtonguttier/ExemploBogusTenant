...
public class MainClienteService : IClienteService
{
    ...
    {
        var faker = new ClienteFaker(nameof(MainClienteService));
        faker.UseSeed(100);
...
{
    public ClienteFaker(string domainName) : base("pt_BR")
    {
        ...
        base.RuleFor(o => o.Email, faker => faker.Internet.Email(provider: domainName));
    }
}